...
@configclass
class GO2WRoughEnvCfg(LocomotionPositionRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        UNITREE_GO2W_CFG.init_state.pos=(0.0, 0.0, 0.45)
        ...
        self.observations.policy.position_commands.scale = (0.5, 0.5)
        ...
        self.observations.critic.position_commands.scale = (0.5, 0.5, 0.5, 1.0)
        ...
        self.rewards.body_lin_acc_l2.weight = -0.01 #-0.1
        self.rewards.body_lin_acc_l2.params["asset_cfg"].body_names = [self.base_link_name]
        self.rewards.body_ang_acc_l2.weight = -0.001 #-0.01
        ...
        self.rewards.joint_vel_l2.weight = -2.5e-4  # -1.e-4
        self.rewards.joint_vel_l2.params["asset_cfg"].joint_names = self.leg_joint_names
        self.rewards.joint_vel_wheel_l2.weight = -1.e-5  # -1.e-4
        self.rewards.joint_vel_wheel_l2.params["asset_cfg"].joint_names = self.wheel_joint_names
        self.rewards.joint_acc_l2.weight = -1.e-7 # -2.5e-7
        self.rewards.joint_acc_l2.params["asset_cfg"].joint_names = self.leg_joint_names
        self.rewards.joint_acc_wheel_l2.weight = 0  # -2.5e-7 # -2.5e-10
        ...
        self.rewards.joint_error.weight = -1.  #-3. #-1.0
        ...
        self.rewards.track_position_xy.weight = 15.0  # 1.5
        self.rewards.track_position_xy.func = mdp.track_position_xy_2
        self.rewards.track_position_xy.params["time_remain_threshold"] = 2.0
        # self.rewards.position_bias_xyz.weight = 1.0
        # self.rewards.position_bias_xyz.params["reward_threshold"] = 0.5 * self.rewards.track_position_xy.weight
        self.rewards.position_bias_xy.weight = 1.0
        self.rewards.position_bias_xy.params["time_remain_threshold"] = 2.0
        self.rewards.position_bias_xy.params["reward_threshold"] = 0.5 * self.rewards.track_position_xy.weight
        self.rewards.do_not_wait.weight = 1.0
        self.rewards.face_goal.weight = 0.2
        ...
        self.rewards.joint_power.weight = 0  # -5.e-6
        self.rewards.joint_power.params["asset_cfg"].joint_names = self.leg_joint_names
        self.rewards.stand_still_without_cmd.weight = -5.0  # -0.4
        ...
        # self.commands.base_position.debug_vis = True
        # self.commands.base_position.ranges = mdp.RobotPoseCommandCfg.Ranges(
        #     pos_x=(1.0, 3.0),
        #     pos_y=(-1.5, 1.5),
        #     pos_z=(UNITREE_GO2W_CFG.init_state.pos[2]-0.1, UNITREE_GO2W_CFG.init_state.pos[2]-0.02),
        # )
