...
class BITTERRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.scene.terrain.terrain_generator = VERTICAL_WALL_TERRAINS_CFG
        ...
        self.rewards.joint_acc_wheel_l2.weight = -2.5e-8  # -2.5e-7 # -2.5e-10
        ...
        self.rewards.feet_height_with_contact.weight = -50.0
        self.rewards.feet_height_with_contact.params["target_height"] = -0.2
        self.rewards.feet_height_with_contact.params["asset_cfg"].body_names = [self.foot_link_name]
        self.rewards.feet_height_with_contact.params["sensor_cfg"].body_names = [self.foot_link_name]
