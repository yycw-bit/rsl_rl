...
# Pre-defined configs
##
from robot_lab.assets.bit import NEZHA_CFG  # isort: skip
...
@configclass
class NEZHAActionsCfg(ActionsCfg):
...
@configclass
class NEZHARewardsCfg(RewardsCfg):
    ...
    # joint_track_error = RewTerm(
    #     func=mdp.joint_track_error_exp, weight=0.0, params={"std": math.sqrt(16), "asset_cfg": SceneEntityCfg("robot", joint_names=".*", preserve_order=True)},
    # )
    # wheel_track_error = RewTerm(
    #     func=mdp.wheel_track_error_exp, weight=0.0, params={"std": math.sqrt(16), "asset_cfg": SceneEntityCfg("robot", joint_names="", preserve_order=True)}
    # )
...
@configclass
class NEZHARoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    actions: NEZHAActionsCfg = NEZHAActionsCfg()
    rewards: NEZHARewardsCfg = NEZHARewardsCfg()
    ...
    def __post_init__(self):
        ...
        NEZHA_CFG.init_state.pos=(0.0, 0.0, 0.55)
        self.scene.robot = NEZHA_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
        ...
        self.actions.joint_wheel_leg.leg_joint_clip = { ".*_hip_joint": (-100.0, 100.0),
                                                ".*_thigh_joint": (-200.0, 100.0),
                                                ".*_calf_joint": (-300.0, 100.0)}
        self.actions.joint_wheel_leg.wheel_joint_clip = {".*_foot_joint": (-30.0, 30.0)}

        # ------------------------------Events------------------------------
        self.events.randomize_rigid_body_mass_base.params["asset_cfg"].body_names = [self.base_link_name]
        self.events.randomize_rigid_body_mass_base.params["mass_distribution_params"] = (-1.0, 2.0)  # add
        ...
        # self.events.randomize_rigid_body_mass_foot = EventTerm(
        # func=mdp.randomize_rigid_body_mass,
        # mode="startup",
        # params={
        #     "asset_cfg": SceneEntityCfg("robot", body_names=[self.foot_link_name]),
        #     "mass_distribution_params": (0.2, 0.25),
        #     "operation": "scale",
        #     "recompute_inertia": True,
        # },
        # )
        # self.events.randomize_rigid_body_mass_calf = EventTerm(
        # func=mdp.randomize_rigid_body_mass,
        # mode="startup",
        # params={
        #     "asset_cfg": SceneEntityCfg("robot", body_names=["FL_calf", "FR_calf", "RL_calf", "RR_calf",]),
        #     "mass_distribution_params": (0.7, 0.75),
        #     "operation": "scale",
        #     "recompute_inertia": True,
        # },
        # )
        # self.events.randomize_rigid_body_mass_thigh = EventTerm(
        # func=mdp.randomize_rigid_body_mass,
        # mode="startup",
        # params={
        #     "asset_cfg": SceneEntityCfg("robot", body_names=["FL_thigh", "FR_thigh", "RL_thigh", "RR_thigh",]),
        #     "mass_distribution_params": (0.55, 0.6),
        #     "operation": "scale",
        #     "recompute_inertia": True,
        # },
        # )
        ...
        # ------------------------------Rewards------------------------------
        # General
        # UNUSED self.rewards.is_alive.weight = 0
        ...
        # UNUSED self.rewards.joint_vel_l1.weight = 0.0
        ...
        self.rewards.straight_shoulder_joints.weight = -0.1
        ...
        if self.__class__.__name__ == "NEZHARoughEnvCfg":
