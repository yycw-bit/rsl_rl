...
from .rough_env_cfg import  NEZHARoughEnvCfg


@configclass
class NEZHAFlatEnvCfg(NEZHARoughEnvCfg):
    def __post_init__(self):
        ...
        self.rewards.joint_vel_l2.weight = -2.0e-06  # -5.e-5  # -2.5e-4  # -1.e-4
        self.rewards.joint_vel_wheel_l2.weight = -2.0e-05  # -1.e-5 # -1.e-4
        self.rewards.joint_acc_l2.weight = -5.e-7  # -5.e-6  # -2.5e-7
        ...
        if self.__class__.__name__ == "NEZHAFlatEnvCfg":
