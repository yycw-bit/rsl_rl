...
class UnitreeGo2WRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.observations.policy.base_ang_vel.history_length = 10
        self.observations.policy.projected_gravity.history_length =10
        self.observations.policy.joint_pos.history_length = 10
        self.observations.policy.joint_vel.history_length = 10
