...
@configclass
class W1ObservationCfg(ObservationsCfg):
...
class W1RoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    observations: W1ObservationCfg = W1ObservationCfg()
    ...
    def __post_init__(self):
        ...
        self.scene.terrain.terrain_generator = VAE_ROUGH_TERRAINS_CFG
        ...
        self.rewards.track_lin_vel_xy_exp.weight = 3.5  # 1.5
        self.rewards.track_ang_vel_z_exp.weight = 2.0  # 1.0
        ...
        self.rewards.base_height_l2.params["target_height"] = 0.55  # 0.40
        self.rewards.base_height_l2.params["asset_cfg"].body_names = [self.base_link_name]
        self.rewards.body_lin_acc_l2.weight = -0.000
        self.rewards.body_lin_acc_l2.params["asset_cfg"].body_names = [self.base_link_name]
        self.rewards.body_ang_acc_l2.weight = -0.000 #-0.01
        self.rewards.body_ang_acc_l2.params["asset_cfg"].body_names = [self.base_link_name]

        # Joint penaltie
        self.rewards.joint_torques_l2.weight = -5.e-5 # -1.e-5
        self.rewards.joint_torques_l2.params["asset_cfg"].joint_names = self.leg_joint_names
        self.rewards.joint_torques_wheel_l2.weight = -5.0e-3 # -1.e-5
        self.rewards.joint_torques_wheel_l2.params["asset_cfg"].joint_names = self.wheel_joint_names
        # UNUESD self.rewards.joint_vel_l1.weight = 0.0
        self.rewards.joint_vel_l2.weight = -1.0e-7  # -1e-7
        self.rewards.joint_vel_l2.params["asset_cfg"].joint_names = self.leg_joint_names
        self.rewards.joint_vel_wheel_l2.weight = -5.e-5  # -1.e-4
        self.rewards.joint_vel_wheel_l2.params["asset_cfg"].joint_names = self.wheel_joint_names
        self.rewards.joint_acc_l2.weight = -5.0e-7  # -2.5e-7
        self.rewards.joint_acc_l2.params["asset_cfg"].joint_names = self.leg_joint_names
        self.rewards.joint_acc_wheel_l2.weight = -2.5e-10 # -2.5e-10
        ...
        self.rewards.joint_vel_limits.weight = -0.0  # -0.05
        ...
        self.rewards.straight_shoulder_joints.weight = -2.0
