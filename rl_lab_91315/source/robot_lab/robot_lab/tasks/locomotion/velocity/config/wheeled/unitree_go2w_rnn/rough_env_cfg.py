...
@configclass
class UnitreeGo2WRoughEnvWithEstimatorCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        # Others
        self.rewards.tracking_contacts_shaped.weight = 0.1
        ...
        self.rewards.stand_still_without_cmd.weight = 0  # -0.4
        ...
        if self.__class__.__name__ == "UnitreeGo2WRoughEnvWithEstimatorCfg":
