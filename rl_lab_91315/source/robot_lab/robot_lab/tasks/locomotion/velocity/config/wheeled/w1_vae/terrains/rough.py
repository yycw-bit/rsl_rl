...
ROUGH_TERRAINS_CFG = TerrainGeneratorCfg(
    ...
    sub_terrains={
        ...
        proportion=0.0, box_height_range=(0.05,0.4), platform_width=2.0, double_box=True
        ),
        "boxes": terrain_gen.MeshRandomGridTerrainCfg(
            proportion=0., grid_width=0.45, grid_height_range=(0.05, 0.2), platform_width=2.0
        ),
        "random_rough": terrain_gen.HfRandomUniformTerrainCfg(
            proportion=0.2, noise_range=(0.02, 0.20), noise_step=0.02, border_width=0.25
        ),
        "curriculum_rough": terrain_gen.HfCurriculumUniformTerrainCfg(
            proportion=0.2, noise_range=(0.02, 0.20), noise_step=0.02, downsampled_scale=0.1,border_width=0.25
        ),
...
VAE_ROUGH_TERRAINS_CFG = TerrainGeneratorCfg(
    size=(10.0, 10.0),
    border_width=8.0,
    num_rows=10,
    num_cols=20,
    ...
    sub_terrains={
        ...
        "wall":terrain_gen.MeshBoxTerrainCfg(
        proportion=0.2, box_height_range=(0.05,0.4), platform_width=2.0, double_box=True
        ),
        "boxes": terrain_gen.MeshRandomGridTerrainCfg(
            proportion=0., grid_width=0.45, grid_height_range=(0.05, 0.2), platform_width=2.0
        ),
        "random_rough": terrain_gen.HfRandomUniformTerrainCfg(
            proportion=0., noise_range=(0.02, 0.20), noise_step=0.02, border_width=0.25
        ),
        "curriculum_rough": terrain_gen.HfCurriculumUniformTerrainCfg(
            proportion=0.1, noise_range=(0.02, 0.20), noise_step=0.02, downsampled_scale=0.1,border_width=0.25
        ),
        "hf_pyramid_slope": terrain_gen.HfPyramidSlopedTerrainCfg(
...
Original_ROUGH_TERRAINS_CFG = TerrainGeneratorCfg(
    size=(8.0, 8.0),
    border_width=20.0,
    num_rows=10,
    num_cols=20,
