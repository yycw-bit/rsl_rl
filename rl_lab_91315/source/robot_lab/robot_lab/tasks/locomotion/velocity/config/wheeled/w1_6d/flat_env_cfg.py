...
class W1FlatEnvCfg(W1RoughEnvCfg):
    def __post_init__(self):
        ...
        self.rewards.body_lin_acc_l2.weight = -0.1  # -0.1
        self.rewards.body_ang_acc_l2.weight = -0.01  # -0.01
        # Joint penaltie
        self.rewards.joint_torques_l2.weight = -2.5e-5  # -1.e-5
        self.rewards.joint_torques_wheel_l2.weight = -5.e-5  # -1.e-5
        # UNUESD self.rewards.joint_vel_l1.weight = 0.0
        self.rewards.joint_vel_l2.weight = -1.e-6  # -1.e-4
        self.rewards.joint_vel_wheel_l2.weight = -2.e-5  # -1.e-4
        self.rewards.joint_acc_l2.weight = -1.0e-5  # -2.5e-7
        ...
        self.rewards.joint_error.weight = -0.5  # -3. #-1.0
        self.rewards.joint_track_error.weight = -1.0e-3
        self.rewards.wheel_track_error.weight = -1.0e-3
        # Action penalties
        ...
        self.rewards.stand_still_without_cmd.func = mdp.wheel_still_without_cmd
        self.rewards.stand_still_without_cmd.weight = -1.0  # -0.4
        self.rewards.straight_shoulder_joints.weight = -0.2
