...
from .vertical_wall_env_cfg import BITTERRoughEnvCfg
...
class BITTERFlatEnvCfg(BITTERRoughEnvCfg):
    def __post_init__(self):
        ...
        self.rewards.joint_error.weight = -3.0  # -3. #-1.0
        self.rewards.joint_track_error.weight = -1.e-3
        self.rewards.wheel_track_error.weight = -1.e-4
        # Action penalties
        self.rewards.action_rate_l2.weight = -0.01  # -0.01
        self.rewards.action_l2.weight = -0.007
        # Contact sensor
        ...
        self.rewards.stand_still_without_cmd.weight = -3.0  # -0.4
