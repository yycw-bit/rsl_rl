...
# Pre-defined configs
##
from robot_lab.assets.unitree import UNITREE_GO2W_CFG, DOOR_CFG  # isort: skip
...
class GO2WRewardsCfg(RewardsCfg):
    ...
    still_hand_joints = RewTerm(
        func=mdp.joint_vel_l1, weight=0.0, params={"asset_cfg": SceneEntityCfg("robot", joint_names="")}
    )
...
class GO2WRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.events.randomize_reset_base.params["pose_range"]["z"] = (0.0, 0.05)
        self.events.randomize_push_robot.params["velocity_range"]["x"] = (-0.1, 0.1)
        self.events.randomize_push_robot.params["velocity_range"]["z"] = (-0.5, 0.5)
        self.events.randomize_push_robot.params["velocity_range"]["roll"] = (-0.5, 0.5)
        ...
        # Joint penaltie
        self.rewards.joint_torques_l2.weight = -2.5e-6  # -2.5e-6 # -1.e-5
        ...
        self.rewards.still_hand_joints.weight = -0.2
        ...
        self.rewards.upward.weight = 1.8 # 2.5
        ...
        self.terminations.bad_orientation.func = mdp.bad_orientation_stand_x
