...
class EventCfg:
    ...
    randomize_rigid_body_material = EventTerm(
        ...
        params={
            ...
            "static_friction_range": (0.3, 1.5), # (0.3, 1.0),
    ...
    randomize_motor_strength = EventTerm(
        ...
        params={
            ...
            "leg_motor_strength_distribution_params": (0.7, 1.3),
            "wheel_motor_strength_distribution_params": (0.7, 1.3),
            "operation": "scale",
...
class RewardsCfg:
    ...
    feet_height_with_contact = RewTerm(
        func=mdp.feet_height_with_contact,
        weight=0.0,
        params={
            "std": math.sqrt(0.25),
            "tanh_mult": 2.0,
...
class CurriculumCfg:
    ...
    # commands_range_vel = CurrTerm(func=mdp.commands_range_vel,
    #                               params={"max_ranges_curriculum": 1.0}
    # )
    lin_vel_cmd_levels = CurrTerm(func=mdp.lin_vel_cmd_levels,
                                  params={"max_range_x": (-2.0, 2.0), "max_range_y": (-1.5, 1.5)})

    ang_vel_cmd_levels = CurrTerm(func=mdp.ang_vel_cmd_levels,
                                  params={"max_range_a": (-1.5, 1.5)})
