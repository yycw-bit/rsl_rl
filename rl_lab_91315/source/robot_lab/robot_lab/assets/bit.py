...
NEZHA_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"/home/bit/ycw/rl_lab_913/source/robot_lab/robot_lab/assets/nezha_1113_v2.usd",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        pos=(0.0, 0.0, 0.50), # 581.7mm
        joint_pos={
            ".*_hip_joint": 0.0,
            "F.*_thigh_joint": 0.9250,
            "R.*_thigh_joint": -0.9250,
            "F.*_calf_joint": -1.8500,
            "R.*_calf_joint": 1.8500,
            ".*_foot_joint": 0.0,
        },
        joint_vel={".*": 0.0},
    ),
...
"""Configuration of Nezha using DC-Motor actuator model."""
