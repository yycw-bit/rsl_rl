...
import omni
import rsl_rl_utils
from rsl_rl.runners import OnPolicyRunnerROA
...
def main():
    ...
    ppo_runner = OnPolicyRunnerROA(env, agent_cfg.to_dict(), log_dir=log_dir, device=agent_cfg.device)
    ...
    private_obs = extras["observations"]["private"].to(agent_cfg.device)
    ...
    while simulation_app.is_running():
        ...
        with torch.inference_mode():
            # agent stepping
            actions = policy(obs, private_obs, history_obs)
