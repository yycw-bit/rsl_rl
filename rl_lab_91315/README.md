...
- Clone this repository separately from the Isaac Lab installation (i.e. outside the `IsaacLab` directory):
  ...
  ```bash
  git clone https://github.com/Renyu-ha/rl_lab.git
  ```
...
- Verify that the extension is correctly installed by running the following command to print all the available environments in the extension:
  ...
  ```
- Change the version of IsaacLab, such as 2.1.0->2.0.0
  ```bash
  cd ~/IsaacLab  # the path to your IsaacLab
  git describe --tags # the installed version
  git fetch --all --tags # list all available versions
  git checkout v2.0.0 # change the target versions
  ./isaaclab.sh --install # install
  ```
  If rsl_rl reports an error
  ```bash
  EXTRAS_REQUIRE = {
  "sb3": ["stable-baselines3>=2.1"],
  "skrl": ["skrl>=1.4.1"],
  "rl-games": ["rl-games==1.6.1", "gym"],
  "rsl-rl": ["rsl-rl-lib@git+https://github.com/leggedrobotics/rsl_rl.git"], # @V...
  }
...
```bash
# Train
python scripts/rsl_rl/cpg/train.py --task RobotLab-Isaac-Cpg-Rough-A1-v0 --headless
# Play
python scripts/rsl_rl/cpg/play.py --task RobotLab-Isaac-Cpg-Rough-A1-v0 
```
...
Unitree Go2w Vision RMA

```bash
# Train Stage1
python scripts/rsl_rl/rma/train.py --task RobotLab-Isaac-Velocity-Rough-Unitree-Go2W-RMA-v0 
# Train Stage2
python scripts/rsl_rl/rma/train.py --task RobotLab-Isaac-Velocity-Rough-Unitree-Go2W-RMA-v0 --if_depth --load_run xxxx_scan --chec model_x.pt
# Resume
python scripts/rsl_rl/rma/train.py --task RobotLab-Isaac-Velocity-Rough-Unitree-Go2W-RMA-v0 --rusume True --load_run time --checkpoint model 
# Play Stage1
python scripts/rsl_rl/rma/play.py --task RobotLab-Isaac-Velocity-Rough-Unitree-Go2W-RMA-v0 --checkpoint path_to_model
# Play Stage2
python scripts/rsl_rl/rma/play.py --task RobotLab-Isaac-Velocity-Rough-Unitree-Go2W-RMA-v0 --if_depth  --checkpoint path_to_model
# Keboard
python scripts/rsl_rl/rma/play.py --task RobotLab-Isaac-Velocity-Rough-Unitree-Go2W-RMA-v0 --keboard --checkpoint path_to_model
```

Unitree Go2w History ROA

```bash
# Train
python scripts/rsl_rl/roa/train.py --task RobotLab-Isaac-Velocity-Rough-Unitree-Go2W-ROA-v0 
# Resume
python scripts/rsl_rl/roa/train.py --task RobotLab-Isaac-Velocity-Rough-Unitree-Go2W-ROA-v0--rusume True --load_run time --checkpoint model 
# Play
python scripts/rsl_rl/roa/play.py --task RobotLab-Isaac-Velocity-Rough-Unitree-Go2W-ROA-v0 --checkpoint path_to_model
# Keboard
python scripts/rsl_rl/roa/play.py --task RobotLab-Isaac-Velocity-Rough-Unitree-Go2W-ROA-v0 --keboard --checkpoint path_to_model
```

Unitree Go2W Position Conditioned (Since isaaclab 2.1.1, Mesh has been aborted. Error!!!!!!!!!!)

```bash
# Train
python scripts/rsl_rl/pos/train.py --task Go2w-Rough-Position-v0
# Resume
python scripts/rsl_rl/pos/train.py --task Go2w-Rough-Position-v0 --rusume True --load_run time --checkpoint model 
# Play
python scripts/rsl_rl/pos/play.py --task Go2w-Rough-Position-v0 --checkpoint path_to_model
# Keboard
python scripts/rsl_rl/pos/play.py --task Go2w-Rough-Position-v0 --keboard --checkpoint path_to_model
```
...
```bash
# Train
python scripts/rsl_rl/stand/train.py --task Go2w-Flat-Switch-v0 
# Resume
python scripts/rsl_rl/stand/train.py --task Go2w-Flat-Switch-v0  --load_run time --checkpoint model 
# Play Stage1
python scripts/rsl_rl/stand/play.py --task Go2w-Flat-Switch-v0  --checkpoint path_to_model
# Keboard
python scripts/rsl_rl/stand/play.py --task Go2w-Flat-Switch-v0  --keboard --checkpoint path_to_model
```
...
```bash
# Train
python scripts/rsl_rl/base/train.py --task RobotLab-Rough-Bitter-v0
# Resume
python scripts/rsl_rl/base/train.py --task RobotLab-Rough-Bitter-v0 --rusume True --load_run time --checkpoint model 
# Play
python scripts/rsl_rl/base/play.py --task RobotLab-Rough-Bitter-v0 --checkpoint path_to_model
# Keboard
python scripts/rsl_rl/base/play.py --task RobotLab-Rough-Bitter-v0 --keboard --checkpoint path_to_model
```
...
```bash
# Train
python scripts/rsl_rl/leg/train.py --task Bitter-One-Leg-Demo-v0
# Resume
python scripts/rsl_rl/leg/train.py --task Bitter-One-Leg-Demo-v0 --rusume True --load_run time --checkpoint model 
# Play
python scripts/rsl_rl/leg/play.py --task Bitter-One-Leg-Demo-v0 --checkpoint path_to_model
# Keboard
python scripts/rsl_rl/leg/play.py --task Bitter-One-Leg-Demo-v0 --keboard --checkpoint path_to_model
```
...
```bash
# Train
python scripts/rsl_rl/base/train.py --task RobotLab-Flat-W1-v0 
# Resume
python scripts/rsl_rl/base/train.py --task RobotLab-Flat-W1-v0 --rusume True --load_run time --checkpoint model 
# Play
python scripts/rsl_rl/base/play.py --task RobotLab-Flat-W1-v0 --checkpoint path_to_model
# Keboard
python scripts/rsl_rl/base/play.py --task RobotLab-Flat-W1-v0 --keboard --checkpoint path_to_model
```
