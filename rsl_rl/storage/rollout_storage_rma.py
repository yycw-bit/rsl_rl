...
class RolloutStorageRMA:
    ...
    def __init__(
        ...
        self.scan_obs_shape = scan_obs_shape
        ...
        self.scan_observations = torch.zeros(
            num_transitions_per_env, num_envs, *scan_obs_shape, device=self.device
        )
    ...
    def mini_batch_generator(self, num_mini_batches, num_epochs=8):
        ...
        for epoch in range(num_epochs):
            for i in range(num_mini_batches):
                ...
                scan_observations_batch = scan_observations[batch_idx]
                ...
                yield obs_batch, critic_observations_batch, scan_observations_batch, actions_batch, target_values_batch, advantages_batch, returns_batch, old_actions_log_prob_batch, old_mu_batch, old_sigma_batch, (
                    None,
                    None,
