...
from rsl_rl.storage import RolloutStorageTNS
...
class Distillation:
    ...
    def __init__(
        ...
        self.transition = RolloutStorageTNS.Transition()
    ...
    def init_storage(self, num_envs, num_transitions_per_env, student_obs_shape, teacher_obs_shape, actions_shape):
        # create rollout storage
        self.storage = RolloutStorageTNS(
            num_envs,
